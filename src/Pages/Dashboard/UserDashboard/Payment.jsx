...
const Payment = () => {
        ...
        const fetchData = async () =>{
            try {
                ...
                if(email){
                    ...
                    axios.get(`https://bazar-bd-server.vercel.appaddCart/${email}`)
    ...
    const handlePayment = async (payment, email, currentDate, name, cart) =>{
        ...
        try{
        axios.post(`https://bazar-bd-server.vercel.apppayment`, {payment, email, currentDate, name, cart})
...
Pay with MasterCard
	...
	<button  onClick={() => {
         ...
         handlePayment(payment, email, currentDate, name, cart); 
