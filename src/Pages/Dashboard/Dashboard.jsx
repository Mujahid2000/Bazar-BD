...
<div className="min-h-screen flex bg-white">
  <div className="sidebar fixed bg-white z-50 min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
    <div className="flex h-screen flex-col justify-between pt-2 pb-6">
      <div>
        <div className="w-max p-2.5">
          <Link to={'/'}>
          
          <img to={'/'} src="https://tailus.io/images/logo.svg" className="w-32" alt=""/>
          </Link>
        </div>
        <ul className="mt-6 space-y-2 tracking-wide">
          ...
          {
            isAdmin? <li className="min-w-max">
