...
const Banner = () => {
  ...
  // Memoize the categories rendering
  ...
  return (
    <div className="flex flex-col pt-32 px-7 md:flex-row justify-center md:justify-between lg:justify-center items-center">
      ...
      {/* User Info */}
      <div
        className={`${user ? 'space-y-10' : 'space-y-2'} hidden lg:flex bg-white py-5 rounded-r-md flex-col items-center px-4`}
      >
        {user ? (
          ...
          <div className="bg-blue-100 hidden lg:block p-5 rounded-lg">
            ...
            <div>
              ...
              <Link to={'/signIn'}>
                <button className="bg-white w-full text-blue-500 py-1 px-4 rounded-md mt-2 border border-blue-500">
                  Log in
                </button>
              </Link>
            </div>
