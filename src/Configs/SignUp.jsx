            ...
            <div className="mt-2 flex flex-col items-center">
                ...
                <div className="w-full mt-4 flex-1 ">
                    ...
                    <form onSubmit={handleSignUp} className="mx-auto max-w-xs">
                        ...
                        <input
                            className="w-full px-8 mt-6 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                ...
                <p className="text-center mt-3 text-sm">Create a New Account <span className="underline text-blue-600" ><Link to={'/signIn'}>SignIn </Link></span></p>
            </div>
        </div>
