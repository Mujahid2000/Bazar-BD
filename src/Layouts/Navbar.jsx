            ...
            <ul className="flex gap-16 text-base">
              ...
              <li className="font-semibold">
                <button
                  ...
                  className="  pl-3 pr-4 py-2  md:hover:text-blue-700 md:p-0  flex items-center justify-between w-full md:w-auto"
                >
                  Help{" "}
                  <svg
                ...
                <div
                  ...
                  className={`${
                    dropDown
                      ? "animate-fade-down bg-white absolute text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44"
                      : " hidden"
                  }`}
                >
            ...
            <ul className="flex gap-5">
              <li>
                <button
                  ...
                  id="dropdownNavbarLink"
                  data-dropdown-toggle="dropdownNavbar"
                  className="  pl-3 pr-4 py-2  md:hover:text-blue-700 md:p-0  flex items-center justify-between w-full md:w-auto font-semibold"
                >
                  English, USD{" "}
                  <svg
                    className="w-4 h-4 ml-1"
